 ...
 *
 * To run this: node download-all.js
 * To run this: node download-all.js <OlderThanID>
 *
 */
...
var oldestFile = '999999999999999999999999'; //Expected max file ID
...
fs.mkdir(base, () => { //ignoring if it exists..
    const doAgain = (goBack) => {	
        ...
        if (goBack !== null) {
            olderthan = goBack.replace("_stamp", "");
